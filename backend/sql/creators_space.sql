...
--
-- Table structure for table `campus_ambassador_applications`
--
...
(1, 'Full Stack Web Development', 'full-stack-web-development', 'Learn complete web development from frontend to backend', 2, '/assets/images/full-stack-web-developer.png', 99.99, '12 weeks', 'intermediate', 'general', NULL, NULL, 1, 0, 0, 0, '2025-09-25 08:11:01', '2025-09-25 08:11:01'),
(2, 'UI/UX Design Fundamentals', 'ui-ux-design-fundamentals', 'Master the fundamentals of user interface and user experience design', 2, '/assets/images/uiux.jpeg', 79.99, '8 weeks', 'beginner', 'general', NULL, NULL, 1, 0, 0, 0, '2025-09-25 08:11:01', '2025-09-25 08:11:01'),
(3, 'JavaScript in 30 Days', 'javascript-30-days', 'Master JavaScript programming in 30 days with practical projects', 2, '/assets/images/jsin30days.png', 49.99, '4 weeks', 'beginner', 'general', NULL, NULL, 1, 0, 0, 0, '2025-09-25 08:11:01', '2025-09-25 08:11:01'),
(4, 'Java Programming Masterclass', 'java-programming-masterclass', 'Complete Java programming course from basics to advanced concepts. Learn OOP, data structures, algorithms, Spring Framework, and enterprise application development.', 2, 'frontend/assets/images/blogpage/java.jpg', 249.99, '16 weeks', 'intermediate', 'Programming', NULL, NULL, 1, 0, 0, 0, '2025-09-25 17:05:56', '2025-09-25 17:05:56'),
(5, 'C++ Game Development', 'cpp-game-development', 'Learn C++ programming through game development. Build 2D and 3D games using modern C++ techniques, game engines, and graphics programming.', 2, 'frontend/assets/images/blogpage/gamedev.jpg', 199.99, '12 weeks', 'advanced', 'Programming', NULL, NULL, 1, 0, 0, 0, '2025-09-25 17:05:56', '2025-09-25 17:05:56'),
(8, 'Vue.js Complete Guide', 'vuejs-complete-guide', 'Master Vue.js framework with Composition API, Vuex, Vue Router, and modern development practices. Build scalable single-page applications.', 2, 'frontend/assets/images/blogpage/vuejs.jpg', 159.99, '8 weeks', 'intermediate', 'Web Development', NULL, NULL, 1, 0, 0, 0, '2025-09-25 17:05:56', '2025-09-25 17:05:56'),
(9, 'Angular Enterprise Development', 'angular-enterprise-development', 'Build large-scale enterprise applications with Angular. Advanced patterns, testing, performance optimization, and deployment strategies.', 2, 'frontend/assets/images/blogpage/angular.jpg', 279.99, '16 weeks', 'advanced', 'Web Development', NULL, NULL, 1, 0, 0, 0, '2025-09-25 17:05:56', '2025-09-25 17:05:56'),
(10, 'Next.js Full-Stack Development', 'nextjs-fullstack-development', 'Build production-ready applications with Next.js. Server-side rendering, API routes, authentication, and deployment to Vercel.', 2, 'frontend/assets/images/blogpage/nextjs.jpg', 199.99, '10 weeks', 'intermediate', 'Web Development', NULL, NULL, 1, 0, 0, 0, '2025-09-25 17:05:56', '2025-09-25 17:05:56'),
(11, 'GraphQL API Development', 'graphql-api-development', 'Master GraphQL for modern API development. Schema design, resolvers, subscriptions, and integration with popular databases and frameworks.', 2, 'frontend/assets/images/blogpage/graphql.jpg', 189.99, '8 weeks', 'advanced', 'Web Development', NULL, NULL, 1, 0, 0, 0, '2025-09-25 17:05:56', '2025-09-25 17:05:56'),
(26, 'Blockchain Development with Solidity', 'blockchain-development-solidity', 'Build decentralized applications (DApps) and smart contracts using Solidity and Ethereum. Web3 development and cryptocurrency integration.', 2, 'frontend/assets/images/blogpage/blockchain.jpg', 349.99, '18 weeks', 'advanced', 'Blockchain', NULL, NULL, 1, 0, 0, 0, '2025-09-25 17:05:56', '2025-09-25 17:05:56'),
(54, 'Design of algorithms', 'design-of-algorithms', 'Students can get basic idea about how algorithms works', 15, NULL, 25.00, '4 weeks', 'beginner', 'Problem solving', NULL, NULL, 1, 0, 0, 0, '2025-09-28 05:20:06', '2025-09-28 05:20:06'),
(55, 'Python for Beginners', NULL, 'Learn Python programming from scratch', 2, NULL, 199.99, '8 weeks', 'beginner', 'general', NULL, NULL, 1, 0, 0, 0, '2025-09-15 05:32:29', '2025-09-28 05:32:29'),
(56, 'React.js Masterclass', NULL, 'Advanced React.js concepts and best practices', 2, NULL, 249.99, '10 weeks', 'advanced', 'general', NULL, NULL, 1, 0, 0, 0, '2025-09-23 05:32:29', '2025-09-28 05:32:29'),
(57, 'Data Science with Python', NULL, 'Learn data analysis and machine learning', 2, NULL, 349.99, '16 weeks', 'intermediate', 'general', NULL, NULL, 1, 0, 0, 0, '2025-08-12 05:32:29', '2025-09-28 05:32:29');
...
ALTER TABLE `bookmarks`
  ...
  ADD KEY `idx_bookmarks_course` (`course_id`);

--
-- Indexes for table `campus_ambassador_applications`
--
ALTER TABLE `campus_ambassador_applications`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_campus_apps_user` (`user_id`),
  ADD KEY `idx_campus_apps_status` (`status`),
  ADD KEY `idx_campus_apps_college` (`college_name`);
...
--
-- AUTO_INCREMENT for table `campus_ambassador_applications`
--
ALTER TABLE `campus_ambassador_applications`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `campus_ambassador_applications`
--
ALTER TABLE `campus_ambassador_applications`
  ADD CONSTRAINT `campus_ambassador_applications_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
